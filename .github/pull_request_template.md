...
<!--
Does this change the generated OpenAPI specification, the plugin's CLI/configuration
contract, or any published artefact? If yes, describe the before/after.
-->

## Downstream modules

<!--
Does this change require follow-up work in any sibling module?
If yes, link the corresponding issues or PRs.
-->

- [ ] No follow-up needed
- [ ] Follow-up required in `openapi-generator-core` — link:
- [ ] Follow-up required in `openapi-generator-maven-plugin` — link:
- [ ] Follow-up required in `openapi-generator-samples` — link:

## How was this tested?

<!--
Describe the tests you added or ran. For source code changes, prefer
adding fixtures under `src/test/resources/` over network/file fixtures.
-->
